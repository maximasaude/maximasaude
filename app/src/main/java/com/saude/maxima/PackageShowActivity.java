...
public class PackageShowActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, DialogInterface.OnCancelListener {
    ...
    public void onDateSet(DatePickerDialog view, int y, int monthOfYear, int dayOfMonth) {
        ...
        timePickerDialog.setOnCancelListener(PackageShowActivity.this);
        timePickerDialog.show(this.getFragmentManager(), "timePickerDialog");
    }
            ...
            try{
                if(!result.has("errors")) {
                    ...
                    if (dayList.size() > 0) {
                        ...
                        datePickerDialog.setOnCancelListener(PackageShowActivity.this);
